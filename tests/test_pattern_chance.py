...
def test_pwhite():
    ...
    a.seed(0)
    assert a.nextn(10) == [0.6888437030500962, 0.515908805880605, -0.15885683833831, -0.4821664994140733,
                           0.02254944273721704, -0.19013172509917142, 0.5675971780695452, -0.3933745478421451,
                           -0.04680609169528838, 0.1667640789100624]
...
def test_pbrown():
    ...
    a.seed(0)
    expected = [0.0, 0.6888437030500962, 1.0, 0.84114316166169, 0.3589766622476167, 0.38152610498483375,
                0.19139437988566232, 0.7589915579552076, 0.36561701011306247, 0.3188109184177741]
...
def test_psample():
    ...
    expected = [[2, 3], [4, 6], [3, 2], [5, 6], [2, 3], [6, 4], [3, 1], [5, 4], [1, 3], [6, 4], [2, 1], [6, 4], [3, 2],
                [5, 4], [2, 3], [5, 4]]
    a.seed(0)
...
def test_psample_weighted():
    ...
    expected = [[2, 1], [4, 5], [1, 2], [5, 4], [1, 2], [6, 4], [1, 3], [5, 4], [3, 2], [5, 6], [1, 3], [6, 5], [1, 2],
                [4, 5], [3, 2], [4, 6]]
    a.seed(0)
    assert a.nextn(16) == expected
    a.reset()
