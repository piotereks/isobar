...
def test_event_degree(dummy_timeline):
    ...
    # ]
    assert dummy_timeline.output_device.events == [
        [0, 'note_on', 12, 64, 0, 0], [1, 'note_off', 12, 0, 0],
        [1, 'note_on', 14, 64, 0, 0], [2, 'note_off', 14, 0, 0],
        [2, 'note_on', 16, 64, 0, 0], [3, 'note_off', 16, 0, 0],
        [3, 'note_on', 17, 64, 0, 0], [4, 'note_off', 17, 0, 0],
        [4, 'note_on', 0, 0, 0, 0], [4.00208333, 'note_off', 0, 0, 0],  # test case needed for Rest/None
        [5, 'note_on', 24, 64, 0, 0], [6, 'note_off', 24, 0, 0],
        [6, 'note_on', 11, 64, 0, 0], [7, 'note_off', 11, 0, 0]
    ]
...
def test_event_octave(dummy_timeline):
    ...
    # ]
    assert dummy_timeline.output_device.events == [
        [0, 'note_on', 24, 64, 0, 0], [1, 'note_off', 24, 0, 0],
        [1, 'note_on', 50, 64, 0, 0], [2, 'note_off', 50, 0, 0],
        [2, 'note_on', 28, 64, 0, 0], [3, 'note_off', 28, 0, 0],
        [3, 'note_on', 53, 64, 0, 0], [4, 'note_off', 53, 0, 0]
    ]
...
def test_event_note_octave(dummy_timeline):
    ...
    assert dummy_timeline.output_device.events == [
        [0, 'note_on', 24, 64, 0, 0], [1, 'note_off', 24, 0, 0],
        [1, 'note_on', 49, 64, 0, 0], [2, 'note_off', 49, 0, 0],
        [2, 'note_on', 26, 64, 0, 0], [3, 'note_off', 26, 0, 0],
        [3, 'note_on', 51, 64, 0, 0], [4, 'note_off', 51, 0, 0]
    ]
...
def test_event_key(dummy_timeline):
    ...
    assert dummy_timeline.output_device.events == [
        [0, 'note_on', 12, 64, 0, 0], [1, 'note_off', 12, 0, 0],
        [1, 'note_on', 19, 64, 0, 0], [2, 'note_off', 19, 0, 0],
        [2, 'note_on', 16, 64, 0, 0], [3, 'note_off', 16, 0, 0],
        [3, 'note_on', 22, 64, 0, 0], [4, 'note_off', 22, 0, 0]
    ]
...
def test_event_dur(dummy_timeline):
    ...
    # ]
    assert dummy_timeline.output_device.events == [
        [0, 'note_on', 1, 64, 0, 0], [1, 'note_off', 1, 0, 0],
        [1, 'note_on', 2, 64, 0, 0], [2.5, 'note_off', 2, 0, 0],
        [2.5, 'note_on', 3, 64, 0, 0], [4.5, 'note_off', 3, 0, 0],
        [4.5, 'note_on', 1, 64, 0, 0], [6, 'note_off', 1, 0, 0]
    ]
...
def test_event_gate(dummy_timeline):
    ...
    # ]
    assert dummy_timeline.output_device.events == [
        [0, 'note_on', 1, 64, 0, 0], [0.5, 'note_off', 1, 0, 0],
        [1, 'note_on', 2, 64, 0, 0], [3, 'note_off', 2, 0, 0],
        [3, 'note_on', 3, 64, 0, 0],
        [4, 'note_on', 4, 64, 0, 0],
        [4.5, 'note_off', 3, 0, 0],
        [5, 'note_off', 4, 0, 0],
        [6, 'note_on', 5, 64, 0, 0], [7, 'note_off', 5, 0, 0],
    ]
...
def test_event_dict_permut(dummy_timeline):
    ...
    assert times == [0.0, 0.5, 0.5, 0.75, 0.75, 1.75, 1.75, 2.25, 2.25, 3.25, 3.25, 3.5, 3.5, 3.75, 3.75, 4.25, 4.25,
                     5.25, 5.25, 5.5, 5.5, 6.5, 6.5, 7.0, 7.0, 8.0, 8.0, 8.5, 8.5, 8.75, 8.75, 9.75, 9.75, 10.0, 10.0,
                     10.5]
    assert notes == [60, 60, 64, 64, 67, 67, 60, 60, 67, 67, 64, 64, 64, 64, 60, 60, 67, 67, 64, 64, 67, 67, 60, 60, 67,
                     67, 60, 60, 64, 64, 67, 67, 64, 64, 60, 60]
